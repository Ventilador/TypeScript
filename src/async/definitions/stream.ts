...
namespace TsAsync {
    ...
    export namespace stream {
        ...
        export interface Stream extends internal { }
        ...
        export interface Readable extends Stream, NodeJS.ReadableStream {
            readable: boolean;
        ...
        export interface Writable extends Stream, NodeJS.WritableStream {
            writable: boolean;
